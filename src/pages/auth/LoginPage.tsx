...
const TAGLINES = [
  ...
  'Because rescue dogs deserve a whole team behind them.',
  'Coordination built for the dogs who need it most.',
];
      ...
      >
        ...
        <div className="relative flex flex-col flex-1 p-10">
          ...
          <div className="mt-auto mb-12">
            ...
            >
              Rescue dog care,{' '}
              <span style={{ color: 'oklch(0.73 0.155 52)' }}>coordinated.</span>
            </p>
